...
<div class="dl-wrap">
    <div class="dl-card">
        ...
        <p class="dl-title">メールアドレスの確認</p>
        <p class="dl-sub">登録済みのメールアドレスを入力してください</p>
        ...
        <form method="POST" action="{{ route('download.verify-email', $token) }}">
            ...
            <input type="email" name="email" class="dl-input" autofocus required>
            <button type="submit" class="dl-btn">次へ →</button>
        </form>
    </div>
</div>
</body>
