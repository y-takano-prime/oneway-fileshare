...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .dl-input { border: 1px solid #D0DEFF; border-radius: 6px; padding: 10px 14px; font-size: 14px; color: #001240; background: #fff; width: 100%; margin-bottom: 12px; }
        .dl-input:focus { outline: none; border-color: #0066FF; box-shadow: 0 0 0 3px rgba(0,102,255,.1); }
        .dl-btn { background: #0066FF; color: #fff; border: none; border-radius: 6px; padding: 11px; font-size: 14px; font-weight: 500; width: 100%; cursor: pointer; margin-top: 4px; }
